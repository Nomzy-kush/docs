---
title: ChatDeepSeek
description: Get started using Deep Seek [chat models](/oss/python/langchain/models) in LangChain.
---

This will help you get started with Deep Seek's hosted [chat models](/oss/python/langchain/models).
