...
**Dependency injection**: Runtime context provides a way to inject dependencies (like database connections, user IDs, or configuration) into your tools at runtime, making them more testable and reusable.
</Info>
...
This is a form of **dependency injection** - the runtime automatically injects these dependencies into your tool functions without you having to pass them explicitly or use global state.
</Info>
