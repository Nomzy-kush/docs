...
<Tip>
    ...
    **Dependency injection**: Runtime context is a form of dependency injection, allowing you to provide dependencies (like database connections, user IDs, or API clients) to your tools and nodes at runtime rather than hardcoding them.
</Tip>
