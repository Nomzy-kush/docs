...
You can limit tool calls globally across all tools, or for specific tools by setting `tool_name`. For each limit, specify one or both of:
...
You can limit tool calls globally across all tools, or for specific tools by setting `toolName`. For each limit, specify one or both of:
