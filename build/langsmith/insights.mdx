...
<Tip>You can also toggle to **Manual** mode to use a [prebuilt config](#using-a-prebuilt-config) for common use cases or [build a custom config](#building-a-config-from-scratch) for full control over categories, prompts, and filters.</Tip>
...
<Frame caption="Prebuilt configurations in Manual mode"><img src="/langsmith/images/insights-manual-config.png" /> </Frame>
