...
The LangSmith Agent Builder Slack app enables your agents to interact with your Slack workspace.
...
The LangSmith Agent Builder requires the following permissions:
...
These permissions enable agents to communicate effectively within your workspace.
