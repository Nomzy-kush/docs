...
This page covers all LangChain integrations with [Google Cloud](https://cloud.google.com/), [Google Gemini](https://ai.google.dev/gemini-api/docs) and other Google products.

1. **Google Generative AI (Gemini API & AI Studio)**: Access Google Gemini models directly via the [Gemini Developer API](https://ai.google.dev/). This is often the best starting point for individual developers.
2. **Google Cloud (Vertex AI & other services)**: Access Gemini models, Vertex AI Model Garden and a wide range of cloud services (databases, storage, document AI, etc.) via the [Google Cloud Platform](https://cloud.google.com/). Use the `langchain-google-vertexai` package for Vertex AI models and specific packages (e.g., `langchain-google-community`, `langchain-google-cloud-sql-pg`) for other cloud services. This is ideal for developers already using Google Cloud or needing enterprise features like MLOps, specific model tuning or enterprise support.
...
Use `ChatGoogleGenerativeAI` to interact with Gemini models. See details in [this guide](/oss/integrations/chat/google_generative_ai).
...
Generate text embeddings using models like `gemini-embedding-001` with `GoogleGenerativeAIEmbeddings`.

See a [usage example](/oss/integrations/text_embedding/google_generative_ai).
...
Access the same Gemini models using the (legacy) LLM interface with `GoogleGenerativeAI`.

See a [usage example](/oss/integrations/llms/google_ai).
...
See a [usage example](/oss/integrations/chat/google_vertex_ai_palm).
...
See a [usage example](/oss/integrations/llms/google_vertex_ai_palm).
...
See a [usage example](/oss/integrations/llms/google_vertex_ai_palm#vertex-model-garden).
...
See a [usage example](/oss/integrations/text_embedding/google_vertex_ai_palm).
...
See [usage example](/oss/integrations/document_loaders/google_alloydb).
...
See a [usage example](/oss/integrations/document_loaders/google_bigquery).
...
See [usage example](/oss/integrations/document_loaders/google_bigtable).
...
See [usage example](/oss/integrations/document_loaders/google_cloud_sql_mysql).
...
See [usage example](/oss/integrations/document_loaders/google_cloud_sql_mssql).
...
See [usage example](/oss/integrations/document_loaders/google_cloud_sql_pg).
...
See [directory usage example](/oss/integrations/document_loaders/google_cloud_storage_directory).

```python
from langchain_google_community import GCSDirectoryLoader
```

See [file usage example](/oss/integrations/document_loaders/google_cloud_storage_file).
...
See [usage example](/oss/integrations/document_loaders/google_el_carro).
...
See [usage example](/oss/integrations/document_loaders/google_firestore).
...
See [usage example](/oss/integrations/document_loaders/google_datastore).
...
See [usage example](/oss/integrations/document_loaders/google_memorystore_redis).
...
See [usage example](/oss/integrations/document_loaders/google_spanner).
...
See [usage example and authorization instructions](/oss/integrations/document_loaders/google_speech_to_text).
...
> [Google Cloud Document AI](https://cloud.google.com/document-ai/docs/overview) is a Google Cloud service that transforms unstructured data from documents into structured data, making it easier to understand, analyze, and consume.
...
See a [usage example](/oss/integrations/document_transformers/google_docai).
...
See [usage example and authorization instructions](/oss/integrations/document_transformers/google_translate).
...
See [usage example](/oss/integrations/vectorstores/google_alloydb).
...
<CodeGroup>
    ```bash pip
    pip install google-cloud-bigquery langchain_google_community
    ```

    ```bash uv
    uv add google-cloud-bigquery langchain_google_community
    ```
</CodeGroup>

See [usage example](/oss/integrations/vectorstores/google_bigquery_vector_search).

```python
from langchain_google_community.vectorstores import BigQueryVectorSearch
```
...
See [usage example](/oss/integrations/vectorstores/google_memorystore_redis).
...
See [usage example](/oss/integrations/vectorstores/google_spanner).
...
See [usage example](/oss/integrations/vectorstores/google_firestore).
...
See [usage example](/oss/integrations/vectorstores/google_cloud_sql_mysql).
...
See [usage example](/oss/integrations/vectorstores/google_cloud_sql_pg).
...
See a [usage example](/oss/integrations/vectorstores/google_vertex_ai_vector_search).
...
See [usage example](/oss/integrations/vectorstores/google_vertex_ai_vector_search/#optional--you-can-also-create-vectore-and-store-chunks-in-a-datastore).
...
> Build generative AI powered search engines using [Vertex AI Search](https://cloud.google.com/generative-ai-app-builder/docs/introduction) from Google Cloud allows developers to quickly build generative AI powered search engines for customers and employees.

See a [usage example](/oss/integrations/retrievers/google_vertex_ai_search).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_cloud_texttospeech).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_drive).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_finance).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_jobs).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_lens).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_places).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_scholar).
...
See [detailed notebook](/oss/integrations/tools/google_search).
...
See [usage example and authorization instructions](/oss/integrations/tools/google_trends).
...
See [usage example and authorization instructions](/oss/integrations/tools/gmail).
...
See [usage example and setup instructions](/oss/integrations/tools/toolbox).
...
See [usage example and authorization instructions](/oss/integrations/document_loaders/google_drive).
...
See a [usage example](/oss/integrations/vectorstores/scann).
...
See [usage example and authorization instructions](/oss/integrations/retrievers/google_drive).
...
See [usage example and authorization instructions](/oss/integrations/chat_loaders/gmail).
...
See [usage examples and authorization instructions](/oss/integrations/tools/searchapi).
...
See a [usage example and authorization instructions](/oss/integrations/tools/serpapi).
...
See a [usage example and authorization instructions](/oss/integrations/tools/google_serper).
...
See a [usage example](/oss/integrations/tools/youtube).
...
See [usage example and authorization instructions](/oss/integrations/document_loaders/youtube_audio).
