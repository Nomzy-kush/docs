...
Trace deletions are processed during non-peak usage times and are not instant. We run the delete job on the weekend. There is no confirmation of deletion - you'll need to query the data again to verify it has been removed.
