...
1. Input a spend limit for your selected workspace. LangSmith will determine an appropriate number of base and extended trace limits to match that spend. The cost calculation incorporates traces already included as part of your plan \(see details on [pricing page](https://smith.langchain.com/settings/payments)\).
