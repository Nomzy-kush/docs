...
Personal organizations are limited to 5,000 traces per month until a credit card is added. You can add a credit card on the **Plans and Billing** page as follows:
