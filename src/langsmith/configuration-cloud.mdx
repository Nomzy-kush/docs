...
To create an assistant, use the [LangGraph SDK](/langsmith/sdk) `create` method. See the @[Python][AssistantsClient.create] and [JS](/langsmith/langgraph-js-ts-sdk#create) SDK reference docs for more information.
...
To edit the assistant, use the `update` method. This will create a new version of the assistant with the provided edits. See the @[Python][AssistantsClient.update] and [JS](/langsmith/langgraph-js-ts-sdk#update) SDK reference docs for more information.
